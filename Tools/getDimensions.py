...
def showQtGUI():
	...
	class QtMainClass(QtGui.QDialog):
		...
		def initUI(self):
			...
			self.ppmO.currentTextChanged.connect(self.setPPM)
			...
			self.rcO.currentTextChanged.connect(self.setRC)
			...
			self.LangO.currentTextChanged.connect(self.setLang)
			...
			self.rpqO.currentTextChanged.connect(self.setQuality)
			...
			self.visibilityO.currentTextChanged.connect(self.setVisibility)
			...
			self.pcvisibilityO.currentTextChanged.connect(self.setPartCutVisibility)
			...
			self.ufdO.currentTextChanged.connect(self.setDFO)
			...
			self.ufaO.currentTextChanged.connect(self.setUFA)
			...
			self.ufsO.currentTextChanged.connect(self.setUFS)
			...
			self.ecO.currentTextChanged.connect(self.setEColor)
