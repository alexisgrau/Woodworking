...
def showQtMain():
	...
	class QtMainClass(QtGui.QDialog):
		...
		def initUI(self):
			...
			self.eTypeO.currentTextChanged.connect(self.setEType)
			...
			self.fileTypeO.currentTextChanged.connect(self.setFileType)
			...
			self.customCSSbo.currentTextChanged.connect(self.setCustomCSSbo)
