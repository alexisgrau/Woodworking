...
def showQtGUI():
	...
	class QtMainClass(QtGui.QDialog):
		...
		def initUI(self):
			...
			self.sMode.activated.connect(lambda index: self.setModeType(self.sMode.itemText(index)))
			...
			self.sCopyType.activated.connect(lambda index: self.setCopyType(self.sCopyType.itemText(index)))
